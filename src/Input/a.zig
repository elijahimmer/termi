//pub fn parseCsiToInput(in: RawInput) Input {
//    const unknown = .{ .event = event, .modifier = modifier, .code = .{ .unknown = undefined } };
//
//    return .{ .event = event, .modifier = modifier, .code = .{ .special = switch (in.mod) {
//        'u' => switch (in.A orelse return unknown) {
...
//        'Q' => .F2,
//        'S' => .F4,
//        '~' => switch (in.A orelse return unknown) {
//            3 => .delete,
//            5 => .page_up,
//            6 => .page_down,
//            7 => .home,
...
//            15 => .F5,
//
//  2                 '0'...'9' => input.csi.B = (input.csi.B o          17 => .F6,
//            18 => .F7,
//            19 => .F8,
//            20 => .F9,
//            21 => .F10,
